...
//Elimine el prompt para agregar guitarra
...
//Eliminamos prompt agregar guitarra
...
for (let guitarBoton of btnAgregar){
    guitarBoton.addEventListener("click", ()=>{console.log(`Usted ha comprado este producto`)})
}
...
function guardarNuevaguitar(){
    ...
    let guitarraCreada = new Guitars(conjuntoGuitarras.length+1, modeloInput.value, anioInput.value, precioInput.value, colorInput.value, "Multimedia/newGuitar.jpg")
    console.log(guitarraCreada)
    conjuntoGuitarras.push(guitarraCreada)
}

//Capturo guardar guitarra boton y asignamos evento
